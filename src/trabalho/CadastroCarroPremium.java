 ...
 * @author Breno
 */
public class CadastroCarroPremium extends javax.swing.JFrame {
        Inicial tela_principal;
        Carro carros;
    /**
     * Creates new form CadastroCarro
     */
    public CadastroCarroPremium() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        caixa_dataDois =  new javax.swing.JFormattedTextField();
        caixa_dataQuatro =  new javax.swing.JFormattedTextField();
        caixa_dataTres =  new javax.swing.JFormattedTextField();
        ...
        try {
            caixa_dataDois.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("        ##    /    ##    /   ####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        caixa_dataDois.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caixa_dataDoisActionPerformed(evt);
            }
        });

        try {
            caixa_dataQuatro.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("        ##    /    ##    /   ####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        caixa_dataQuatro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caixa_dataQuatroActionPerformed(evt);
            }
        });

        try {
            caixa_dataTres.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("        ##    /    ##    /   ####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        caixa_dataTres.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caixa_dataTresActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(caixa_dataTres, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(caixa_dataQuatro, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(caixa_dataUm)
                                .addGap(25, 25, 25)
                                .addComponent(caixa_dataDois))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(255, 255, 255)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(caixa_dataDois, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(30, 30, 30)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(caixa_dataQuatro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(caixa_dataTres, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String agendaTres =caixa_dataTres.getText();
    ...
    private void caixa_dataDoisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caixa_dataDoisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_caixa_dataDoisActionPerformed

    private void caixa_dataQuatroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caixa_dataQuatroActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_caixa_dataQuatroActionPerformed

    private void caixa_dataTresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caixa_dataTresActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_caixa_dataTresActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroCarroPremium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroCarroPremium().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField caixa_dataDois;
    private javax.swing.JFormattedTextField caixa_dataQuatro;
    private javax.swing.JFormattedTextField caixa_dataTres;
